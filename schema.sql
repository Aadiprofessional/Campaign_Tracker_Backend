...
--
CREATE TABLE "campaigns_campaign" ("id" uuid NOT NULL PRIMARY KEY, "name" varchar(255) NOT NULL, "description" text NULL, "platform" varchar(50) NOT NULL, "status" varchar(50) NOT NULL, "budget" double precision NOT NULL, "amount_spent" double precision NOT NULL, "start_date" date NOT NULL, "end_date" date NOT NULL, "target_audience" text NULL, "goal" varchar(50) NOT NULL, "roi" double precision NULL, "created_at" timestamp with time zone NOT NULL);
COMMIT;
